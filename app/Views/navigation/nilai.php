                        ...
                        <tbody>
                            ...
                            <?php if (!empty($kelasList)): ?>
                                ...
                                <?php foreach ($kelasList as $kelas => $daftarMapel): ?>
                                    ...
                                    <tr
                                        id="<?= $rowKelasId ?>"
                                        class="nilai-mapel-dropdown-row"
                                        style="display:none;">
                                                    ...
                                                    <table class="table table-hover mb-0">
                                                        ...
                                                        <tbody>
                                                            <?php foreach ($daftarMapel as $index => $m): ?>
                                                                ...
                                                                <tr
                                                                    id="<?= $rowPertemuanId ?>"
                                                                    class="nilai-pertemuan-dropdown-row"
                                                                    style="display:none;">
                        ...
                        <tbody>
                            <?php if (!empty($mapelPribadi)): ?>
                                <?php foreach ($mapelPribadi as $index => $m): ?>
                                    ...
                                    <tr
                                        id="<?= $rowPertemuanId ?>"
                                        class="nilai-pertemuan-pribadi-row"
                                        style="display:none;">
...
<style>
    ...
    .nilai-kelas-row,
    .nilai-mapel-row,
    .nilai-mapel-pribadi-row {
        cursor: pointer;
        background: #ffffff;
    }

    .nilai-kelas-row:hover,
    .nilai-mapel-row:hover,
    .nilai-mapel-pribadi-row:hover {
        background: #f8fafc;
    }
    ...
    .nilai-row-title strong,
    .nilai-mapel-title strong {
        color: #0f172a;
        font-size: 14px;
    }

    .nilai-row-title .dropdown-icon,
    .nilai-mapel-title .dropdown-icon {
        margin-left: auto;
        color: #64748b;
    }
    ...
    .nilai-mapel-dropdown-row>td,
    .nilai-pertemuan-dropdown-row>td,
    .nilai-pertemuan-pribadi-row>td {
        background: #f8fafc;
        padding: 14px;
    }
    ...
    .nilai-pertemuan-title strong {
        color: #0f172a;
        font-size: 14px;
    }

    .nilai-pertemuan-title span {
        color: #64748b;
        font-size: 13px;
    }

    .nilai-pertemuan-list {
        display: flex;
        flex-wrap: wrap;
        gap: 9px;
    }

    .nilai-pertemuan-list button {
        border: 1px solid #dbeafe;
        background: #eef4ff;
        color: #2563eb;
        padding: 8px 13px;
    ...
    .nilai-pertemuan-list button:hover {
        background: #2563eb;
        color: #ffffff;
    }
